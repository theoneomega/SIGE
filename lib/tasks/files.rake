namespace :files do
  desc "read historical pdf files from public directory"
  ...
  desc "read events pdf files from public directory"
  ...
  desc "read offices pdf files from public directory"
  ...
  desc "read colaborations pdf files from public directory"
  ...
  desc "read justices pdf files from public directory"
