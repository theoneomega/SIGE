...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { id: @phone.id, phone_number: @phone.phone_number, registered_from: @phone.registered_from }
    end
  ...
  test "should update phone" do
    put :update, id: @phone, phone: { id: @phone.id, phone_number: @phone.phone_number, registered_from: @phone.registered_from }
    assert_redirected_to phone_path(assigns(:phone))
  end
